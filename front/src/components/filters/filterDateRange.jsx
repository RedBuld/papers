...
function FilterDateRange({label,options,values,setValue})
{
    ...
    useEffect( () => {
        setValue({'min':minInputValue,'max':maxInputValue,'mode':'date-range'})

...
function BondsFolderBasePage()
{
    ...
    {
        const response = await API.get(`/folders/id/${params.id}`)
        ...
        <div className="min-w-full">
            ...
            <div className="flex flex-row justify-between items-center gap-4 mb-4 bg-white p-4 rounded-lg shadow-md shadow-gray-300">
                ...
                <div className="inline-flex gap-4">
                    <button onClick={openEditModal} className="inline-flex items-center rounded-lg p-2 shadow-sm text-gray-400 hover:text-gray-600 bg-gradient-to-b from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300">
                    ...
                    <button onClick={openDeleteConfirmationModal} className="inline-flex items-center rounded-lg p-2 shadow-sm text-gray-400 hover:text-gray-600 bg-gradient-to-b from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300">
